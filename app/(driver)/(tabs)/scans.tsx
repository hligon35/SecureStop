...
import { Badge, Button, Chip, Divider, IconButton, List, Modal, Portal, Text, TextInput, useTheme } from 'react-native-paper';
...
export default function DriverScansScreen() {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 4, paddingTop: 4, paddingBottom: 16 }}>
        {filteredScans.length === 0 ? (
          <View style={{ paddingHorizontal: 4, paddingVertical: 12 }}>
            <Text style={{ color: theme.colors.onSurfaceVariant }}>No scans match your current filters.</Text>
          </View>
        ) : (
